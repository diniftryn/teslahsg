                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="map.php">Map</a></li>
                        </ul>
                    </div>
        ...
        var data = google.visualization.arrayToDataTable([
          ['Country', 'Staff'],
            ...
            ['Australia', 100]
                    <?php /* cant work in JS.
                    $map = "SELECT * FROM it";
                    $fire = mysqli_query ($db,$map);
                    while ($outcome = mysqli_fetch_assoc ($fire)) {
                      echo"['" .$outcome['country']. "',".$outcome['ticket_id']."],";
                    } */
                    ?> 
        ]);
        var options = {};
